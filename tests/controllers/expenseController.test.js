...
//Add routes for controller functions
...
describe('Expense Controller', () => {
    ...
    //Test for update Expense API success functionality
    ...
    //Test for update Expense API when the expense to be updated is not found
    it('should return 404 if expense to be updated is not found', async () => {
        ...
        //Act: Call update expense API with the incorrect expense id in the URL
            ...
            expect(res.body.error).to.equal('Expense not found.'); //Check error message in the response body
    });

    //Test for delete Expense API
    ...
    it('should fetch expense details', async () => {
        ...
        expect(res.body).to.have.property('totalExpenses'); //Check response body has totalExpenses
